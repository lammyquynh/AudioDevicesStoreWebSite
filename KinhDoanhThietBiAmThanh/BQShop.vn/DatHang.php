...
<table cellpadding="0" cellspacing="0">
  <tr >
   ...
   <div class="khung01">
    ...
    <div class="khung2">
        <div class="tieude">Danh sách đơn đặt hàng</div>
    	<table width="100%">
        	...
        	<?php 
					...
					$sql = 'select * from dathang, khachhang where dathang.idKH = khachhang.id';
					$sp = mysql_query($sql);
        	...
        	<tr bgcolor="#FFFFFF" align="center">
                ...
                <td><a href="Xoa_DH.php?id=<?php echo $row["idDH"]; ?>" onclick="return thongbao()"><img src="icon/Xoa.PNG" width="20" height="20"/></a></td>
            </tr>
            <?php }?>
        </table>
    </div>
