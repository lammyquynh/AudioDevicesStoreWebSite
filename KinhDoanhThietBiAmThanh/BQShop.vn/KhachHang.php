...
<table cellpadding="0" cellspacing="0">
  <tr >
   ...
   <div class="khung01">
                ...
                <img src="icon/tieubieu.png" width="18" height="18" /><a href="#"><b>Đơn hàng chưa giao</b></a>
                <img src="icon/new.png" width="18" height="18" /><a href="#"><b>Đơn hàng đã giao</b></a>
                <img src="icon/hetsl.png" width="18" height="18" /><a href="#"><b>Đơn hàng hoàn trả</b></a>
   </div>
        
   </div>
    <div class="khung2">
         <div class="tieude">Danh sách khách hàng</div>
    	<table width="100%">
        	...
        	<tr bgcolor="#FFFFFF" align="center">
                ...
                <td><?php
                	$time = $row['timedk'];
					$nam = $time/10000;
					$thang = ($time%10000)/100;
					$ngay = $time%100;
					echo (int)$ngay.'/'.(int)$thang.'/'.(int)$nam;
				?></td>
                <td><?php echo $row['CongThanhToan']; ?></td>
                <td><a href="#?id=<?php echo $row["id"]; ?>"><img src="icon/Sua.png" width="20" height="20" /></a></td>
                <td><a href="#?id=<?php echo $row["id"]; ?>"><img src="icon/Xoa.PNG" width="20" height="20"/></a></td>
            </tr>
            <?php }?>
        </table>
    </div>
