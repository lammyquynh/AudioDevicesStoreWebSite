   ...
   <div class="khung01">
   	...
   	<div class="khung1">
    	...
    	<table class="x" cellpadding="0" cellspacing="0">
            ...
            <tr>
            	<td align="right" bgcolor="#FFFFCC">Tin cần sửa:</td>
                <td  align="left">
               
                	<select name="tintuc">
                        	<?php $sql_theloai = "select * from tintuc ORDER BY idtin ASC";
									$sql_tl = mysql_query($sql_theloai);
									while($row_tl = mysql_fetch_array($sql_tl))
									{
							 ?>
                            <option value="<?php echo $row_tl['idtin']; ?>">
							<?php echo $row_tl['tieude'];?></option>
							<?php } ?>
                        </select>
            ...
            <tr>
            	<td align="right" bgcolor="#FFFFCC">Đặt tiêu đề:</td>
                <td align="left"><input name="txttieude" type="text" /></td>
            </tr>
            <tr>
        ...
        <div class="them"><input type="submit" value="Thay đổi ảnh" name="btnthaydoi"/></div>
         </form>
    </div>
   </td>
  </tr>
