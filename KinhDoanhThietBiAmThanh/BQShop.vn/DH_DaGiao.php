...
<?php
	if(isset($_POST['giaohang']))
	{
		...
		if(isset($_POST['check']))
		{
			...
			{
				$sql_giaohang = "Update dathang Set TrangThai = 1 Where idDH = ".$value;
...
<table cellpadding="0" cellspacing="0">
  <tr >
   ...
   <div class="khung01">
    ...
    <div class="khung2">
        <div class="tieude">Danh sách đơn hàng đã giao</div>
        <form method="post">
    	...
    	<table width="100%">
        	...
        	<?php 
					...
					$sql = 'select * from dathang, khachhang where dathang.idKH = khachhang.id AND TrangThai = 1';
					$sp = mysql_query($sql);
