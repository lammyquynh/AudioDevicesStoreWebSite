...
<body>
<form name="4_Index_update" method="post" action="4_Index_update.php"  >
<div class="content">
<center><h2>THÔNG TIN KHÁCH HÀNG</h2></center>
<table width="748" height="170" border="1" align="center" cellpadding="5" style="border-collapse:collapse" bgcolor="#999999">
	<tr bgcolor="#999999" >
...
?>
    <tr>
        ...
        <td><a href="4_Form_Edit.php?id=<?php echo $KH["Ma_khach"]?>">Sửa</a></td> </td>
    </tr>
<?php
    } 
?>
