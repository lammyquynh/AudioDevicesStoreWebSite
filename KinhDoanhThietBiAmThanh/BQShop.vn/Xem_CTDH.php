   ...
   <div class="khung01">
    ...
    <div class="khung2">
    	...
    	<table width="100%">
        	...
        	<?php 
					$sql_dh = 'select * from hoadon, sanpham, loaisp where hoadon.idSP = sanpham.idSP AND sanpham.idLoaiSP = loaisp.id AND idDH = '.$idDH;
					$dathang = mysql_query($sql_dh);
					$sl = 0;
					$tongtien = 0;
					while($row = mysql_fetch_array($dathang))
					{
						$sl = $sl + $row['soluongSP'];
						$tongtien = $tongtien + ($row['soluongSP'] * $row['DonGia']);
			  ?>
        	<tr bgcolor="#FFFFFF" align="center">
                ...
                <td><a href="#"><img src="icon/Sua.png" width="20" height="20" /></a></td>
                <td><a href="#"><img src="icon/Xoa.PNG" width="20" height="20"/></a></td>
            </tr>
            <?php }?>
        </table>
        <div class="tongtien">
        	Tổng số lượng sản phẩm: <?php echo $sl; ?><br />
            Tổng thành tiền: <?php echo $tongtien.' VNĐ'; ?>
        </div>
    </div>
   </td>
  </tr>
